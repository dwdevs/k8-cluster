...
sudo stemctl enable docker.service --now
...
sleep 3 
sudo kubeadm join 192.168.88.169:6443 --token 3spjo6.y57m27tiyovbikf7 --discovery-token-ca-cert-hash sha256:867f0563363d956012fe5a848a2059b9085db7bd1281bffbe310b3948cc23a5a
